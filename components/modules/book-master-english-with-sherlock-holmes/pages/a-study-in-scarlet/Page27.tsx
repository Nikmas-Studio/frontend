  ...
  return (
    <PageWrapper pageNumber={pageNumber} viewportHeight={viewportHeight}>
      ...
      <BookMainContainer>
        ...
        <div className='flex  max-2md:flex-col'>
          <BookLeftPartContainer>
            <TextNode noIndent>
              ...
              him when he thought of the young man's return, and of the
              impending loss of his adopted child. Yet her bright and happy face
              ...
              wed a Mormon. Such a marriage he regarded as no marriage at all,
              but as a shame and a disgrace. Whatever he might think of the
              Mormon doctrines, upon that one point he was inflexible. He had to
              seal his mouth on the subject, however, for to express an
              unorthodox opinion was a dangerous matter in those days in the
              Land of the Saints.
            </TextNode>
            ...
            <TextNode>
              ...
              persecutors of the most terrible description. Not the Inquisition
            ...
            <TextNode>
              ...
              hasty act was followed by annihilation, and yet none knew what the
              nature might be of this terrible power which was suspended over
              them. No wonder that men went about in fear and trembling, and
              that even in the heart of the wilderness they dared not whisper
            ...
            <TextNode>
              ...
              re-corroborated, until they resolved themselves into a definite
            ...
            <TextNode>
              ...
              those who would come forth at night with fire and sword to exact a
              terrible reparation. Hence every man feared his neighbour, and
            ...
            <TextNode>
              ...
              keenly from under his light-coloured eyelashes, “the true
              believers have been good friends to you. We picked you up when you
              were starving in the desert, we shared our food with you, led you
              safe to the Chosen Valley, gave you a goodly share of land, and
              allowed you to wax rich under our protection. Is not this so?”
            </TextNode>

            <TextNode>“It is so,” answered John Ferrier.</TextNode>
            ...
            <TextNode>
              ...
              hands in expostulation. “Have I not given to the common fund? Have
            ...
            <TextNode>
              ...
              were few, and there were many who had better claims than I. I was
              not a lonely man: I had my daughter to attend to my wants.”
            </TextNode>
          </BookLeftPartContainer>
          <BookRightPartContainer>
            ...
            <TextNode>John Ferrier groaned internally.</TextNode>
            ...
            <TextNode>
              “Upon this one point your whole faith shall be tested—so it has
              been decided in the Sacred Council of Four. The girl is young, and
              we would not have her wed grey hairs, neither would we deprive her
              of all choice. We Elders have many heifers<sup>1</sup>, but our
            ...
            <TextNode>
              “No; of course not. I shouldn't care to hear you say you did. He's
              a likely lad, and he's a Christian, which is more than these folk
              here, in spite o' all their praying and preaching. There's a party
              starting for Nevada to-morrow, and I'll manage to send him a
              message letting him know the hole we are in. If I know anything o'
              that young man, he'll be back here with a speed that would whip
              electro-telegraphs.”
            </TextNode>
            ...
            <TextNode>
              ...
              time to look out for squalls when we do. We have a clear month
              before us; at the end of that, I guess we had best shin out of
              Utah.”
            </TextNode>

            <TextNode>“Leave Utah!”</TextNode>

            <TextNode>“That's about the size of it.”</TextNode>

            <TextNode>“But the farm?”</TextNode>

            <TextNode>
              “We will raise as much as we can in money, and let the rest go. To
              tell the truth, Lucy, it isn't the first time I have thought of
              doing it. I don't care about knuckling under to any man, as these
              folk do to their darned prophet. I'm a free-born American, and
        ...
        <div className='mt-10'>
          <hr
            className='mb-3  w-80  max-w-full  border-gray-light-darker
                     max-sm:w-full  dark:border-gray-dark-lighter'
          />
          <BookLeftPartContainer>
            <TextNode noIndent>
              <sup>1</sup>Heber C. Kemball, in one of his sermons, alludes to
