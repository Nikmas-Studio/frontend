...
function BookNavigator({ demo = false }: { demo?: boolean }): ReactElement {
              ...
              <>
                ...
                <div className='mb-7'>
                  <BasicTextNode
                    className={`mb-5  text-xl  ${libreBaskerville.className}`}
                  >
                    Chapter VI. A Continuation of the Reminiscences of John
                    Watson, M.D.
                  </BasicTextNode>
                  <ul className='grid  gap-3  [grid-template-columns:repeat(auto-fit,minmax(165px,165px))]'>
                    {generateRangeArray(
                ...
                <div
                  id={storyToPartId(Story.A_CASE_OF_IDENTITY)}
                  className='mb-7'
                >
                  <BasicTextNode
                    className={`mb-5  text-xl  ${libreBaskerville.className}`}
                ...
                <div id={storyToPartId(Story.SILVER_BLAZE)} className='mb-7'>
                  ...
                  <ul className='grid  gap-3  [grid-template-columns:repeat(auto-fit,minmax(165px,165px))]'>
                    {generateRangeArray(
                      DETAILED_BOOK_PART_PAGE_RANGES
                        .THE_MEMOIRS_OF_SHERLOCK_HOLMES.SILVER_BLAZE,
                    ).map((pageNumber) => {
                      return (
                        <BookNavigatorPage
                          pageNumber={pageNumber}
                ...
                <div id={storyToPartId(Story.THE_YELLOW_FACE)} className='mb-7'>
                  ...
                  <ul className='grid  gap-3  [grid-template-columns:repeat(auto-fit,minmax(165px,165px))]'>
                    {generateRangeArray(
                      DETAILED_BOOK_PART_PAGE_RANGES
                        .THE_MEMOIRS_OF_SHERLOCK_HOLMES.THE_YELLOW_FACE,
                    ).map((pageNumber) => {
                      return (
                        <BookNavigatorPage
                          pageNumber={pageNumber}
                ...
                >
                  ...
                  <ul className='grid  gap-3  [grid-template-columns:repeat(auto-fit,minmax(165px,165px))]'>
                    {generateRangeArray(
                      DETAILED_BOOK_PART_PAGE_RANGES
                        .THE_MEMOIRS_OF_SHERLOCK_HOLMES.THE_STOCK_BROKERS_CLERK,
                    ).map((pageNumber) => {
                      return (
                        <BookNavigatorPage
                          pageNumber={pageNumber}
                ...
                <div
                  id={storyToPartId(Story.THE_GLORIA_SCOTT)}
                  className='mb-7'
                >
                  <BasicTextNode
                    className={`mb-5  text-xl  ${libreBaskerville.className}`}
                  ...
                  <ul className='grid  gap-3  [grid-template-columns:repeat(auto-fit,minmax(165px,165px))]'>
                    {generateRangeArray(
                      DETAILED_BOOK_PART_PAGE_RANGES
                        .THE_MEMOIRS_OF_SHERLOCK_HOLMES.THE_GLORIA_SCOTT,
                    ).map((pageNumber) => {
                      return (
                        <BookNavigatorPage
                          pageNumber={pageNumber}
                ...
                <div
                  id={storyToPartId(Story.THE_MUSGRAVE_RITUAL)}
                  className='mb-7'
                >
                  <BasicTextNode
                    className={`mb-5  text-xl  ${libreBaskerville.className}`}
                  ...
                  <ul className='grid  gap-3  [grid-template-columns:repeat(auto-fit,minmax(165px,165px))]'>
                    {generateRangeArray(
                      DETAILED_BOOK_PART_PAGE_RANGES
                        .THE_MEMOIRS_OF_SHERLOCK_HOLMES.THE_MUSGRAVE_RITUAL,
                    ).map((pageNumber) => {
                      return (
                        <BookNavigatorPage
                          pageNumber={pageNumber}
                ...
                <div
                  id={storyToPartId(Story.THE_REIGATE_SQUIRES)}
                  className='mb-7'
                >
                  <BasicTextNode
                    className={`mb-5  text-xl  ${libreBaskerville.className}`}
                  ...
                  <ul className='grid  gap-3  [grid-template-columns:repeat(auto-fit,minmax(165px,165px))]'>
                    {generateRangeArray(
                      DETAILED_BOOK_PART_PAGE_RANGES
                        .THE_MEMOIRS_OF_SHERLOCK_HOLMES.THE_REIGATE_SQUIRES,
                    ).map((pageNumber) => {
                      return (
                        <BookNavigatorPage
                          pageNumber={pageNumber}
                ...
                <div id={storyToPartId(Story.THE_CROOKED_MAN)} className='mb-7'>
                  ...
                  <ul className='grid  gap-3  [grid-template-columns:repeat(auto-fit,minmax(165px,165px))]'>
                    {generateRangeArray(
                      DETAILED_BOOK_PART_PAGE_RANGES
                        .THE_MEMOIRS_OF_SHERLOCK_HOLMES.THE_CROOKED_MAN,
                    ).map((pageNumber) => {
                      return (
                        <BookNavigatorPage
                          pageNumber={pageNumber}
                ...
                >
                  ...
                  <ul className='grid  gap-3  [grid-template-columns:repeat(auto-fit,minmax(165px,165px))]'>
                    {generateRangeArray(
                      DETAILED_BOOK_PART_PAGE_RANGES
                        .THE_MEMOIRS_OF_SHERLOCK_HOLMES.THE_RESIDENT_PATIENT,
                    ).map((pageNumber) => {
                      return (
                        <BookNavigatorPage
                          pageNumber={pageNumber}
                ...
                >
                  ...
                  <ul className='grid  gap-3  [grid-template-columns:repeat(auto-fit,minmax(165px,165px))]'>
                    {generateRangeArray(
                      DETAILED_BOOK_PART_PAGE_RANGES
                        .THE_MEMOIRS_OF_SHERLOCK_HOLMES.THE_GREEK_INTERPRETER,
                    ).map((pageNumber) => {
                      return (
                        <BookNavigatorPage
                          pageNumber={pageNumber}
                ...
                <div
                  id={storyToPartId(Story.THE_NAVAL_TREATY)}
                  className='mb-7'
                >
                  <BasicTextNode
                    className={`mb-5  text-xl  ${libreBaskerville.className}`}
                  ...
                  <ul className='grid  gap-3  [grid-template-columns:repeat(auto-fit,minmax(165px,165px))]'>
                    {generateRangeArray(
                      DETAILED_BOOK_PART_PAGE_RANGES
                        .THE_MEMOIRS_OF_SHERLOCK_HOLMES.THE_NAVAL_TREATY,
                    ).map((pageNumber) => {
                      return (
                        <BookNavigatorPage
                          pageNumber={pageNumber}
                ...
                <div
                  id={storyToPartId(Story.THE_FINAL_PROBLEM)}
                  className='mb-12'
                >
                  <BasicTextNode
                    className={`mb-5  text-xl  ${libreBaskerville.className}`}
                  ...
                  <ul className='grid  gap-3  [grid-template-columns:repeat(auto-fit,minmax(165px,165px))]'>
                    {generateRangeArray(
                      DETAILED_BOOK_PART_PAGE_RANGES
                        .THE_MEMOIRS_OF_SHERLOCK_HOLMES.THE_FINAL_PROBLEM,
                    ).map((pageNumber) => {
                      return (
                        <BookNavigatorPage
                          pageNumber={pageNumber}
                ...
                <div className='mb-7'>
                  ...
                  <ul className='grid  gap-3  [grid-template-columns:repeat(auto-fit,minmax(165px,165px))]'>
                    {generateRangeArray(
                      DETAILED_BOOK_PART_PAGE_RANGES
                        .THE_HOUND_OF_THE_BASKERVILLES.CHAPTER_3_THE_PROBLEM,
                    ).map((pageNumber) => {
                      return (
                        <BookNavigatorPage
                          pageNumber={pageNumber}
                ...
                <div
                  id={storyToPartId(Story.THE_VALLEY_OF_FEAR)}
                  className='mb-7'
                >
                  <BasicTextNode
                    className={`mb-1.5  text-xl  font-bold  ${libreBaskerville.className}`}
