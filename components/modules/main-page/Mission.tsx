...
function Mission(): ReactElement {
  return (
    <section className='mb-[7.5rem]  lg:mb-48'>
      <MainContainer>
        <TextNode
          className='opacity-1  [transition:opacity_1s_ease-out]  
                     first-letter:float-left  first-letter:text-8xl  
                     first-letter:[line-height:0.8]  first-letter:mr-1
                     first-letter:mt-[0.3rem]  text-xl  !mb-0  w-[23rem]
                     sm:mx-auto  lg:text-2xl  lg:w-[27.6rem]  lg:first-letter:text-[7.2rem]
                     lg:leading-snug  lg:first-letter:mt-[0.28rem]'
        >
